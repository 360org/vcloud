...
void main() {
  group('Security & ReDoS Verification for URL Regex', () {
    ...
    test('1. Valid URLs must match correctly', () {
      expect(
        safeUrlRegex.hasMatch('Truy cap https://vuahethong.net ngay'),
        isTrue,
      );
    ...
    test(
      '2. Adversarial ReDoS payload — max 20ms cho chuỗi 1000 ký tự không khớp',
      () {
        ...
        print(
          '[PERF METRIC] ReDoS payload 1000 chars: ${stopwatch.elapsedMicroseconds} µs (${stopwatch.elapsedMilliseconds} ms)',
        );
        expect(
          stopwatch.elapsedMilliseconds,
          lessThan(20),
          reason: 'Regex too slow — potential ReDoS',
        );
    ...
    test('3. Repetitive dot payload — max 20ms', () {
      ...
      print(
        '[PERF METRIC] Repetitive dot payload: ${stopwatch.elapsedMicroseconds} µs',
      );
